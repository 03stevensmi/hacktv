...
OBJS    := hacktv.o common.o fir.o vbidata.o teletext.o wss.o video.o mac.o dance.o videocrypt.o videocrypts.o videocrypt-ca.o syster.o syster-ca.o acp.o vits.o vitc.o nicam728.o test.o ffmpeg.o file.o hackrf.o font.o subtitles.o eurocrypt.o graphics.o
