...
const static ec_mode_t _ec_modes[] = {
	...
	{ "ctvs",        EC_S2,   EC_S2, { 0x17, 0x38, 0xFA, 0x8A, 0x84, 0x5A, 0x5E, 0x00 }, { 0x00, 0x2B, 0x20 }, { "TODAY"      }, { 0xFF, 0x00 }, "CTV (S2)" },
	...
	{ "cplus",     EC_3DES, EC_3DES, { 0x62, 0xA7, 0x01, 0xA0, 0x5E, 0x8B, 0xB9, 0x00,  /* Key 02 and key 03 - index key E */
	                                   0xCB, 0x86, 0x67, 0x27, 0x5C, 0x53, 0x17, 0x00 }, { 0x00, 0x2B, 0x1E }, { "TODAY"      }, { 0xFF, 0x00 }, "Canal+ DK (3DES)" },
	{ NULL } 
};
