...
const pngs_t png_logos[] = {
	...
	{ "mcm",            _png_mcm,            IMG_POS_TR, sizeof(_png_mcm) },
	{ "mtv",            _png_mtv,            IMG_POS_TR, sizeof(_png_mtv) },
	{ "record",         _png_record,         IMG_POS_TR, sizeof(_png_record) },
	{ "odeon",          _png_odeon,          IMG_POS_TL, sizeof(_png_odeon) },
	{ "rage",           _png_rage,           IMG_POS_BL, sizeof(_png_rage) },
	{ "tac",            _png_tac,            IMG_POS_TR, sizeof(_png_tac) },
	{ "citv",           _png_citv,           IMG_POS_TL, sizeof(_png_citv) },
	...
	{ "xtv2",           _png_xtv2,           IMG_POS_BR, sizeof(_png_xtv2) },
	...
	{ "videomusic",     _png_vm,             IMG_POS_BR, sizeof(_png_vm) },
